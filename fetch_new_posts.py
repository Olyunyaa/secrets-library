...
5. Внутрянка большого бизнеса — устройство и экономика продукта Prosto; инсайты и наблюдения изнутри крупных корпораций (опыт как сотрудника или партнёра большой компании).
   ВАЖНО: если Таня говорит про найм, команду или процессы в своём малом бизнесе — это «Путь предпринимателя», не эта категория. Внутрянка = только Prosto или большие корпорации.
